...
<head>
  ...
  <title>Meta - Gereniamento de Estoque</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-mini">  <img id="profile-img" class="profile-img-card" src="/img/logo.png" /></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Meta Telecom</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- User Account: style can be found in dropdown.less marcio-->
         ...
         <!-- botao de configuracao do layout do sistema--> 
          <!--<li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <!--menu perfil administrador -->
        ...
        <li class="treeview active">
           <a href="#">
            <i class="fa fa-bookmark-o"></i> <span>Administrativo</span>
          ...
          <ul class="treeview-menu">
              ...
              <ul class="treeview-menu">
                <!--<li><a href="../configuracao/index.php"><i class="fa fa-circle-o"></i> Configuração</a></li>-->
                <li><a href="../cliente"><i class="fa fa-circle-o"></i>Cliente</a></li>
                <li><a href="../produto"><i class="fa fa-circle-o"></i> Produto</a></li>
                 <li><a href="../usuario"><i class="fa fa-circle-o"></i> Usuários</a></li>
                   <!--<li class="treeview">
        ...
        <!--<li class="treeview active">
           <a href="#">
            <i class="fa fa-book"></i> <span>Administrativo</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
              ...
              <ul class="treeview-menu">
               ...
               <!-- <li><a href="../inadimplentes/index.php"><i class="fa fa-circle-o"></i> Inadimplentes</a></li>
                 <li><a href="../estruturaPagamentos/index.php"><i class="fa fa-circle-o"></i> Estrutura Pagamento</a></li>-->
                <!--<li class="treeview">
                  <a href="#"><i class="fa fa-circle-o"></i> 
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
